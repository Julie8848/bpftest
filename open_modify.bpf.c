...
/* This struct must live directly in this .bpf.c file so that `ecc`
 * can statically infer the ringbuffer's export type. Keeping it only
 * in open_modify.h prevents ecc from detecting it. */
struct event {
